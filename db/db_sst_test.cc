...
TEST_F(DBSSTTest, OpenDBWithExistingTrash) {
  ...
  ASSERT_OK(
      WriteStringToFile_RDMA(env_, "abc", dbname_ + "/" + "001.sst.trash"));
  ASSERT_OK(
      WriteStringToFile_RDMA(env_, "abc", dbname_ + "/" + "002.sst.trash"));
  ASSERT_OK(
      WriteStringToFile_RDMA(env_, "abc", dbname_ + "/" + "003.sst.trash"));
